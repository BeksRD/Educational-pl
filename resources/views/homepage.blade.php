...
@section('content')
    ...
    @include('assets.search_box')

    <!--====== SLIDER PART START ======-->

    <section id="slider-part" class="slider-active">
        <div class="single-slider slider-2 bg_cover" style="background-image: url(images/slider/s-2.jpg)"
             data-overlay="4">
            <div class="container">
                <div class="row">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(images/slider/s-3.jpg)"
             data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
        ...
        <div class="single-slider slider-2 bg_cover" style="background-image: url(images/slider/s-1.jpg)"
             data-overlay="4">
            <div class="container">
                <div class="row">
                    <div class="col-xl-9 col-lg-10">
                    ...
                    <div class="singel-course-2">
                        <div class="thum">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="images/course/teacher/t-1.jpg"
                                                                       alt="teacher"></a>
                                </div>
                                <div class="name">
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="images/course/teacher/t-2.jpg"
                                                                       alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="images/course/teacher/t-3.jpg"
                                                                       alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="images/course/teacher/t-4.jpg"
                                                                       alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                ...
                <div class="col-lg-4">
                    <div class="singel-course-2">
                        <div class="thum">
                            ...
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-singel.html"><img src="images/course/teacher/t-5.jpg"
                                                                       alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark anthem</h6></a>
                    ...
                    <div class="happy-student mt-55">
                        ...
                        <div class="student-slied">
                            <div class="singel-student">
                                ...
                                <p>Aliquetn sollicitudirem quibibendum auci elit cons equat ipsutis sem nibh id elit.
 ...
 @include('assets.sub_connections')
@endsection
